...
version -> 'v0.4-alpha-16-g4d5a726 (4d5a726f8005c6765b1871d3cd7638b7caffadcb)
x86_64 GNU/Linux 2024-04-24 23:36'
...
input_exp_dsl -> (a U[10000000000.] b)
gen_tests -> 'false'
...
*/
  ...
  #ifndef RTM_COMPUTE_BA2B_H_
  #define RTM_COMPUTE_BA2B_H_
  ...
  public:
    ...
    static three_valued_type eval_phi2(T &trace, timespan &t) {
      ...
      return sf;
        ...
        template<class T>
        three_valued_type _rtm_compute_ba2b_0 (T &trace, timespan &t) {
          return until_less<T, Eval_until_less_1<T>, 10000000000>(trace, t);
        };

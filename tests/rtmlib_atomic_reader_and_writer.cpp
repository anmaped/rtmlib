...
int rtmlib_atomic_reader_and_writer() {
  ...
  auto consumer1 = [](void *) -> void*
  {
    ...
    printf("c1: %x %x ret:%d |%x| |%x| (%x) %d\n", (uint32_t) node1.getData(), (uint32_t) node1.getTime(), (uint32_t) __out, (uint32_t) buf.length(), (size_t) reader_1.length(), (uint32_t) count, (uint32_t) gap);
  ...
  __attribute__ ((unused)) __task consumer_1 = __task("consumer1", consumer1, PRIO, SCHED_OTHER, 1000);
  ...
  auto consumer2 = [](void *) -> void*
  {
    ...
    printf("c2: %x %x ret:%d |%x| |%x| (%x) %d\n", (uint32_t) node1.getData(), (uint32_t) node1.getTime(), (uint32_t) __out, (uint32_t) buf.length(), (size_t) reader_2.length(), (uint32_t) count, (uint32_t) gap);
  ...
  __attribute__ ((unused)) __task consumer_2 = __task("consumer2", consumer2, PRIO, SCHED_OTHER, 3000);
  ...
  __attribute__ ((unused)) __task producer_1 = __task("producer1", producer1, PRIO, SCHED_OTHER, 6000);
  ...
  while(consumer_1.st != ABORTED || consumer_2.st != ABORTED || producer_1.st != ABORTED){ };
